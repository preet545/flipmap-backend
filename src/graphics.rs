...
impl<'a> State<'a> {
    ...
    async fn new(window: &'a Window, vertices : Vec<Vertex>) -> State<'a> {
        ...
        let bgcolor = wgpu::Color { r: 0.0, g: 0.0, b: 0.0, a: 1.0};
...
pub async fn run(points: &Vec<(f64, f64)>) {
    ...
    // colors TODO fix colorspace to sRGB
    // blue: (93, 168, 153)
    // pink: (238, 102, 119)
    let vertices = points.iter().map(|(x, y)|
        Vertex { 
            position: [*x as f32, *y as f32, 0.0],
            // color: [0.36470588235294116, 0.6588235294117647, 0.6] // blue
            color: [0.933333, 0.4, 0.466666666667] // pink
        },
        ).collect();
